...
import pickle, re, json, requests, base64
import rsa, binascii, time, logging, getpass
...
if __name__ == '__main__':
    ...
    WB = WeiboLogin(username=username, password=password)
    logined = WB.Login()
    if logined:
        session = WB.session
        with open('login.cookie', 'wb') as f:
